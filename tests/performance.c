...
static void hash_streamhash5(void *, int);
...
static void hash_streamhash5(void *data, int data_len) {
    unsigned char hash_value[512/8];
    STREAMHASH5(data, data_len, hash_value);
}
